    ...
    return(
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {listRepo.map(repo => (
                ...
                <a href={"https://github.com/" + repo.full_name} target="blank"
                    ...
                    <img src={repo.owner.avatar_url} className="shadow-black hover:shadow-2xl rounded-full h-20"  alt="User Avatar" />
                    <h1 className="ml-5 my-auto text-slate-300">{repo.full_name}</h1>
                </a>
            ))}
        </div>
 )
